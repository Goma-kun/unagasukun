...
#ifndef UNAGASUKUN_SWIFT_H
#define UNAGASUKUN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Unagasukun",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// <em>iOS の既定は「前面のときは出さない」。</em> 予定の時刻にアプリを見ていた人だけ
/// お知らせを受け取れないのは、この道具の趣旨に合わない
SWIFT_CLASS("_TtC10Unagasukun31ForegroundNotificationPresenter")
@interface ForegroundNotificationPresenter : NSObject <UNUserNotificationCenterDelegate>
